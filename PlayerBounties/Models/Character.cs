...
namespace PlayerBounties.Models
{
    public class Character
    {
        ...
        [StringLength(50, ErrorMessage = "Your character name must be less than {1} characters.")]
        public string Name
        {
            get;
            set;
        ...
        [StringLength(4000, ErrorMessage = "Your motto must be less than {1} characters.")]
        public string Motto
        {
            get;
            set;
        ...
        [DataType(DataType.MultilineText)]
        [StringLength(4000, ErrorMessage = "Your bio must be less than {1} characters.")]
        public string Bio
        {
            get;
            set;
        ...
        public int GetClientRankingsByShard(Guid shardId, Guid characterId)
        {
            Bounty bounty = new Bounty();
            var topPlayers = new List<TopPlayers>();
            ...
            // get placed count for each character
            foreach (Character characterListItem in characterList)
            {
                topPlayers.Add(new TopPlayers
                {
                    CharacterId = characterListItem.Id,
                    count = bounty.GetBountiesPlacedCount(characterListItem.Id)
                });
            }
